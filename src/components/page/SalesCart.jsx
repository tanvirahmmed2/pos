  ...
  return (
    <div className='w-full flex flex-col gap-6 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm'>
      <div className='flex items-center justify-between'>
        ...
        <button onClick={clearCart} className='text-[10px] font-bold text-slate-800 bg-slate-50 px-3 py-1.5 rounded-lg hover:bg-slate-800 hover:text-white transition-all uppercase tracking-wider'>Clear Cart</button>
      </div>
